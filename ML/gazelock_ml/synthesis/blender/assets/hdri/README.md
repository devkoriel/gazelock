...
All assets in this directory are CC0 / public domain from Poly Haven,
which ships every asset under CC0 by default. See `MANIFEST.json` for
sources. Binaries are gitignored — only the manifest + this README
live in git.
...
1. Find a CC0-licensed HDRI (Poly Haven is the default source)
